...
final class ArtifactCompiler
{
    ...
    private function composeArtifact(array $artifact): TransformerResult
    {
        ...
        $capturedDialogs = isset($artifact['__normalized']) ? array('files' => $normalized['files'], 'diagnostics' => array(), 'projected_count' => 0) : ( new CapturedDialogProjector() )->project($normalized['files']);
