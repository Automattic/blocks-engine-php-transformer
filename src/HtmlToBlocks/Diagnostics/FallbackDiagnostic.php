...
final class FallbackDiagnostic
{
    ...
    private static function defaults(array $fields): array
    {
        ...
        return match ( $code ) {
            ...
            'html_iframe_surface_capability_gap' => array(
                'severity'              => 'warning',
                'conversion_classification' => 'capability_gap',
                'loss_class'            => 'capability_gap',
                'diagnostic_class'      => 'iframe_surface_capability_gap',
                'preservation_strategy' => 'diagnostic_only',
                'runtime_requirement'   => 'third_party_embed_runtime',
                'recoverability'        => 'recoverable_with_portable_embed_destination',
                'actionability'         => 'supply_portable_iframe_destination_or_accept_capability_gap',
                'suggested_repair_class' => 'record_iframe_capability_gap',
                'suggested_primitive'   => 'embed',
                'materialization_hint'  => 'custom_iframe_surfaces_require_a_single_safe_https_destination; reject_unsafe_ambiguous_credential_bound_or_source_runtime_only_hosts_without_raw_html',
            ),
