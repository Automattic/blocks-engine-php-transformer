...
$assert(! str_contains($nestedLayoutTableMarkup, '<!-- wp:html') && str_contains($nestedLayoutTableMarkup, 'href="/quote"') && str_contains($nestedLayoutTableMarkup, 'src="quote.jpg"') && str_contains($nestedLayoutTableMarkup, 'src="mark.jpg"') && str_contains($nestedLayoutTableMarkup, 'Layout copy'), 'nested layout table lowering preserves links, media, and content order without HTML fallback');
