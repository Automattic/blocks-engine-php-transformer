...
$postCluster = (new ArtifactCompiler())->compile(array('entrypoint' => 'index.html', 'files' => array('index.html' => '<header>Shared</header><main>Home</main>', array('path' => 'notes/first.html', 'content' => '<header>Shared</header><main><article><time datetime="2026-08-01">First</time></article></main>', 'metadata' => array('post_type' => 'post')), array('path' => 'notes/second.html', 'content' => '<header>Shared</header><main><article><time datetime="2026-08-02">Second</time></article></main>', 'metadata' => array('post_type' => 'post')), array('path' => 'notes/variant.html', 'content' => '<header>Variant</header><main><article><time datetime="2026-08-03">Variant</time></article></main>', 'metadata' => array('post_type' => 'post')))))->toArray()['source_reports']['wordpress_site_plan'];
