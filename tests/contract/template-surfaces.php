...
$assert('single' === ($figmaFiles['blog-post-desktop.html']['metadata']['template_surface']['role'] ?? null) && 'archive' === ($figmaFiles['archive-desktop.html']['metadata']['template_surface']['role'] ?? null) && '404' === ($figmaFiles['404-page-desktop.html']['metadata']['template_surface']['role'] ?? null) && !isset($figmaFiles['single.html']['metadata']['template_surface'], $figmaFiles['archive.html']['metadata']['template_surface'], $figmaFiles['404.html']['metadata']['template_surface'], $figmaFiles['index.html']['metadata']['template_surface']), 'Figma route-derived template sources declare artifact metadata while canonical aliases and Home remain content.');
