...
$assert(isset($figmaTemplates['single'], $figmaTemplates['archive'], $figmaTemplates['404']) && 1 === count($figmaOperations) && 'index.html' === ($figmaOperations[0]['source_path'] ?? null) && 'index.html' === (($figmaPlan['operations'][1]['front_page_source_path'] ?? null)), 'Figma Home Page remains a front-page content record while Figma single, archive, and 404 surfaces become templates.');
