...
$assert(str_contains($imageCss, '{display:block;width:100%;height:100%;max-width:100%;object-fit:cover;object-position:inherit;border-radius:inherit}') && ! str_contains($imageCss, '> img{width:123px') && ! str_contains($imageCss, '> img{width:86.356%'), 'canonical nested images fill explicitly owned wrapper geometry without applying source dimensions twice');
