...
$assert(str_contains($shellCss, ':root :where(.wp-block-custom-layout-shell) .block-editor-inner-blocks,:root :where(.wp-block-custom-layout-shell) .block-editor-block-list__layout{display:contents}'), '6: layout-shell keeps Gutenberg InnerBlocks wrappers out of the preserved source layout topology');
