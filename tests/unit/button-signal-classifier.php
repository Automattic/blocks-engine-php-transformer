...
$assert(str_contains($wrappedIconCss, '> :where(.wp-block-button__link)') && str_contains($wrappedIconCss, 'background:#25d366') && str_contains($wrappedIconCss, 'min-height:44px') && str_contains($wrappedIconMarkup, 'wp:button') && ! str_contains($wrappedIconMarkup, '<button'), '32: wrapped icon button projects inner-surface paint onto the native link without retaining nested button markup', $wrappedIconMarkup . $wrappedIconCss);
