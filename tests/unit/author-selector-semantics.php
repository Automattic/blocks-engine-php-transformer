...
$wrappedPercentageIconButton = $transform('<style>.icon-wrap{width:34.759px;height:34.917px}</style><button><span>WhatsApp</span><div class="icon-wrap"><svg viewBox="0 0 34.759 34.917" width="100%" height="100%" data-figma-vector="true" aria-hidden="true"><path d="M0 0h34.759v34.917z"/></svg></div></button>');
