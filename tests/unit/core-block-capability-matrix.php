...
if (array('core/paragraph', 'core/tabs') !== $coverage['runtime_available_blocks'] || null !== $coverage['runtime_registered_blocks']) throw new RuntimeException('Runtime availability must be reported independently of capability classification and absent live registrations.');
