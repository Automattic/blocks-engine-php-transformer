...
$assert(str_contains($style, 'height:var(--blocks-engine-carousel-height,auto)') && str_contains($style, 'slide--active{position:relative'), 'slideshows without a captured pixel height still size to the active slide so controls remain hittable');
