...
$videoMarkup = (string) ((new HtmlTransformer())->transform('<wix-video class="bg-video"><video class="player" src="hero.mp4" poster="hero.jpg" autoplay loop muted playsinline controls><track kind="captions" src="captions.vtt" srclang="en" label="English" default></video><wow-image data-image-info="bounded"><img src="hero.jpg" alt=""></wow-image></wix-video>')->toArray()['serialized_blocks'] ?? '');
