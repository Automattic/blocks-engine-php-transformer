...
$assert(str_contains($frontEditorCss, 'blocks-engine-editor-anchor-') && !str_contains($frontThemeJsonCss, 'blocks-engine-editor-anchor-'), 'Editor anchor compatibility CSS is present in editor settings without leaking through frontend theme JSON.');
$assert(str_contains($frontEditorThemeJsonCss, 'blocks-engine-editor-anchor-'), 'Block-editor theme JSON includes editor-only presentation CSS in the stylesheet path rendered by the editor iframe.');
global $wp_query;
