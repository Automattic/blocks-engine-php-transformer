...
$assert(str_contains($fixture87Saved, 'min-height:var(--h);--a:#27485f;--b:#87d8ff;--h:280px') && str_contains($fixture87Saved, 'border-color:#d8dee9;border-style:solid;border-width:1px;border-radius:16px;min-height:430px;padding-top:1.2rem;padding-right:1.2rem;padding-bottom:1.2rem;padding-left:1.2rem;--tone:#315b74'), 'WordPress parse/save retains fixture87 gallery --h and card --tone in the canonical core group style order.');
