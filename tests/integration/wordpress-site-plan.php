...
$assert('custom/accessible-link' === ($accessibleLinkBlocks[0]['innerBlocks'][0]['blockName'] ?? null) && 'custom/accessible-link' === ($accessibleLinkBlocks[0]['innerBlocks'][1]['blockName'] ?? null) && 'https://lovable.dev' === ($accessibleLinkBlocks[0]['innerBlocks'][0]['attrs']['href'] ?? null) && 'Build with Lovable' === ($accessibleLinkBlocks[0]['innerBlocks'][0]['attrs']['accessibleLabel'] ?? null) && 'badge' === ($accessibleLinkBlocks[0]['innerBlocks'][0]['attrs']['sourceAttributes']['data-cta'] ?? null) && 'partner' === ($accessibleLinkBlocks[0]['innerBlocks'][0]['attrs']['sourceAttributes']['data-kind'] ?? null) && 'badge-help' === ($accessibleLinkBlocks[0]['innerBlocks'][0]['attrs']['sourceAttributes']['aria-describedby'] ?? null) && str_starts_with((string) ($accessibleLinkBlocks[0]['innerBlocks'][0]['attrs']['content'] ?? ''), '<img') && str_contains((string) ($accessibleLinkBlocks[0]['innerBlocks'][0]['attrs']['content'] ?? ''), 'Créé 東京') && 'raw-source' === ($accessibleLinkBlocks[0]['innerBlocks'][1]['attrs']['contentMode'] ?? null) && 'https://wa.me/15551234567' === ($accessibleLinkBlocks[0]['innerBlocks'][1]['attrs']['href'] ?? null) && '_blank' === ($accessibleLinkBlocks[0]['innerBlocks'][1]['attrs']['linkTarget'] ?? null) && 'noreferrer' === ($accessibleLinkBlocks[0]['innerBlocks'][1]['attrs']['rel'] ?? null) && str_contains((string) ($accessibleLinkBlocks[0]['innerBlocks'][1]['attrs']['content'] ?? ''), '<button class="whatsapp-surface">') && str_contains($accessibleLinkReloaded, 'https://lovable.dev') && str_contains($accessibleLinkReloaded, 'https://wa.me/15551234567') && str_contains($accessibleLinkReloaded, 'target="_blank"') && str_contains($accessibleLinkReloaded, 'rel="noreferrer"') && str_contains($accessibleLinkReloaded, 'data-cta="badge"') && !str_contains($accessibleLinkSaved, '<!-- wp:html'), 'WordPress parses, saves, reloads, and reparses the registered typed accessible-link companion for both retained Lovable and classless icon-only nested-button WhatsApp source shapes with source order, Unicode, URL, target, rel, and semantic selector attributes.');
