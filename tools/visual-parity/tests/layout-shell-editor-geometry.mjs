...
const editorMarkup = `<div class="${shellClass}" style="display:contents"><div class="shell blocks-engine-source-div-outer-3"><section class="hero blocks-engine-source-section-branch-3" data-anchor="hero"><div class="block-editor-inner-blocks blocks-engine-layout-shell-editor-inner-blocks"><div class="block-editor-block-list__layout"><div class="background" data-anchor="background"></div><div class="content" data-anchor="content">Copy</div></div></div></section></div></div>`;
const authorCss = `
...
const editorCss = '.block-editor-inner-blocks{position:relative;width:360px}';
